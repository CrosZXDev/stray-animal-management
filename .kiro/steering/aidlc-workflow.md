...
# AI-DLC Workflow Active — stray-animal-management
...
- **Manifest**: `.aidlc/workflow/stray-animal-management/aidlc-manifest.yaml`
- **Specs**: `.aidlc/specs/stray-animal-management/`
- **Workflow**: `.aidlc/workflow/stray-animal-management/`
...
1. Read `.aidlc/workflow/stray-animal-management/aidlc-manifest.yaml` for current state
...
- **Feature**: stray-animal-management
- **Language**: th
- **Specs**: `.aidlc/specs/stray-animal-management/`
